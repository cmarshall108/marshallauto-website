...
class TestDriveForm(FlaskForm):
    ...
    license_date_of_birth = DateField('Date of Birth', validators=[Optional()])
    license_expiration_date = DateField('Expiration Date', validators=[Optional()])
    license_address = StringField('License Address', validators=[Optional(), Length(max=255)])
