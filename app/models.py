...
class Lead(db.Model):
    ...
    # Automated spam triage (see app/spam_filter.py)
    is_spam = db.Column(db.Boolean, default=False, nullable=False, index=True)
    spam_score = db.Column(db.Integer, default=0, nullable=False)
    spam_reasons = db.Column(db.String(512), nullable=True)
